...
>
> 2016年06月[内地、港澳台、美国、澳大利亚]同时投票，揭榜最后一秒顶住超高并发请求
>
> ......
...
[12306 系统在 2015 年春运高峰期的稳定运行，采用了哪些具体技术？](https://www.zhihu.com/question/27321479 "12306 系统在 2015 年春运高峰期的稳定运行，采用了哪些具体技术？")  - 来源知乎
...
[阿里云域名备案流程](https://beian.aliyun.com/ "阿里云域名备案流程")  - 来源阿里云
...
[为什么DNS根服务器只能有13台呢？](https://www.zhihu.com/question/22587247 "为什么DNS根服务器只能有13台呢？")  - 来源知乎
...
[如何在阿里云搭建业务生产ECS服务器？](https://www.zhihu.com/question/22587247 "[如何在阿里云搭建业务生产ECS服务器？](https://www.zhihu.com/question/22587247 "为什么域名根服务器只能有13台呢？") ")  - 来源 李牧牧博客



> 阿里云，你开门阿，我知道你还在里面！

相信你根据文章《如何在阿里云搭建业务生产服务器？》已经租赁配置好业务生产服务器，能够给用户提供业务数据的服务器就好像面馆，面馆终于开门营业了，来吃面的用户越来越多，为了防止用户太多把面馆挤跨，面馆老板决定每次只接纳部分用户进门吃面，人满后关上门让其他用户在门外等待，可是门外的用户哪知道你是关门营业还是让他们排队等候，而且吃面还要那么久的队，用户体验不佳下次就不来了。老板即时发现问题，决定再开一家面馆，并且在两家面馆门前安排一位迎宾美女，当老面馆正在接待顾客时，迎宾美女引导排队顾客去新面馆就餐，哪怕老面馆重新装修，只要通知迎宾美女，她就会带顾客去其他门店，如果顾客越来越多，只需要加开门店并告诉迎宾美女，问题迎刃而解。这里说的新老两家面馆就是两台业务生产服务器，迎宾美女就是负载均衡，重新装修就是程序更新与发包。

[如何配置阿里云SLB负载均衡并连通服务器？](https://www.zhihu.com/question/22587247 "如何配置阿里云SLB负载均衡并连通服务器？")  - 来源 李牧牧博客
...
[如何搭建阿里云主从RDS数据库并配置安全规则？](https://www.zhihu.com/question/22587247 "如何搭建阿里云主从RDS数据库并配置安全规则？")  - 来源 李牧牧博客
...
[如何安装阿里云Redis缓存系统并配置持久化？](https://www.zhihu.com/question/22587247 "如何安装阿里云Redis缓存系统并配置持久化？")  - 来源 李牧牧博客
...
[如何部署阿里云OSS分片存储系统并配置专属域名？](https://www.zhihu.com/question/22587247 "如何部署阿里云OSS分片存储系统并配置专属域名？")  - 来源 李牧牧博客
...
[如何配置阿里云CDN内容分发网络？](https://www.zhihu.com/question/22587247 "如何配置阿里云CDN内容分发网络？")  - 来源 李牧牧博客
...
[如何部署阿里云MQ消息队列平台并设置安全规则？](https://www.zhihu.com/question/22587247 "如何部署阿里云MQ消息队列平台并设置安全规则？")  - 来源 李牧牧博客
...
- 推荐用ECS搭建初期的缓存服务，当业务量上去，再迁移到阿里云的缓存解决方案；换句话说就是，用户流量小时用ECS自己搭建缓存服务就够用了，当用户流量增大时，建议不要通过增加ECS内存服务器数量的方式扩容缓存系统；单核4G内存ECS（主从）服务器平均每月需要287.3元，而阿里云缓存产品平均每月只有204元，相对来说即划算又稳定，用户流量大了还是迁移到阿里云缓存产品中才好，并且缓存产品提供内存扩容、主从服务、融灾备份，确实节省了不少时间。
